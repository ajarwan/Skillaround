...
export class SupplierInfo extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public OnSaveDetails() {
    ...
    //debugger
    if (Validator.StringIsNullOrEmpty(this.User.PhoneNumberControl.internationalNumber))
      this.UserValidation.PhoneNumber = true;
    else
      this.User.PhoneNumber = this.User.PhoneNumberControl.internationalNumber;
