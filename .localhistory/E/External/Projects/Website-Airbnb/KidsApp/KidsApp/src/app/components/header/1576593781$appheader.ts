 ...
 ****************************/
  ...
  public OnSignUpSystem() {
    ...
    if (!this.UserValidation.ValidNewEmail)
      return;
    ...
    this.userSVC.Signup(this.User, true).subscribe((res: any) => {
      ...
      this.UserValidation.UserAlreadyExisit = true;
    })
  ...
  public OnEmailTyping() {
    ...
    this.userSVC.CheckEmail(this.User.Email).subscribe((res: any) => {
      if (res)
        this.UserValidation.ValidNewEmail = true;
      else
        this.UserValidation.ValidNewEmail = false;
    })
  }
}
