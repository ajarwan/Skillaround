...
export class SupplierInfo extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public OnSaveDetails() {
    ...
    this.User.StartWorkingTime = '09:00:00.0000000'//this.SelectedStartTime.toTimeString();
    this.User.EndWorkingTime = '09:00:00.0000000' //this.SelectedEndTime.toTimeString();
