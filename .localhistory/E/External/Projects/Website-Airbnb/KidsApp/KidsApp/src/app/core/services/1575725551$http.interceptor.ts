...
export class HttpInterceptor {
  ...
  public get(urlConfig: UrlConfig, showSpinner: boolean = true, islocal: boolean = false): Observable<Response> {
    ...
    return this.invoke(this.http.get<Response>(urlConfig.url, this.getRequestOptions(urlConfig)), showSpinner);

  }

  public post(urlConfig: UrlConfig, body: any, showSpinner: boolean = true): Observable<Response> {
    return this.invoke(this.http.post<Response>(this.getFullUrl(urlConfig), body, this.getRequestOptions(urlConfig)), showSpinner);
  }

  public put(urlConfig: UrlConfig, body: any, showSpinner: boolean = true): Observable<Response> {
    return this.invoke(this.http.put<Response>(this.getFullUrl(urlConfig), body, this.getRequestOptions(urlConfig)), showSpinner);
  }

  public delete(urlConfig: UrlConfig, showSpinner: boolean = true): Observable<Response> {
    return this.invoke(this.http.delete<Response>(this.getFullUrl(urlConfig), this.getRequestOptions(urlConfig)), showSpinner);
  }
  ...
  private invoke(httpCall: Observable<HttpEvent<Response>>, showSpinner: boolean): Observable<Response> {
    if (showSpinner) {
   ...
   * ONs
   */
  private onMap(res: HttpEvent<Response>): any {
