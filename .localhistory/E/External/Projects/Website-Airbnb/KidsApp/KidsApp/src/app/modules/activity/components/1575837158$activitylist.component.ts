...
export class ActivityListComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public LoadActivities() {
    ...
    this.activitySVC.FindAllActivities(this.Criteria, this.Pager.PageIndex, this.Pager.PageSize, 'CreateDate DESC, Id DESC', this.ActivityInclude.join(','), true).subscribe((res: any) => {
