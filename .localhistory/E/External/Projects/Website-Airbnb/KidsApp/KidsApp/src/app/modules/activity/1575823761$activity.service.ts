...
export class ActivityService {
  ...
  public FindActivityPriceRange(showSpinner: boolean): Observable<Response> {

    return this.http.get(new UrlConfig(`${this.ACTIVITY_BASE_URL}FindActivityPriceRange`, this.mainEndPoint), showSpinner);
  }
