...
export class UsersService {
  ...
  public SendMessage(userId: number, msg: string, showSpinner: boolean = true): Observable<Response> {

    let params: SearchParams = new SearchParams();

    params.set('userId', userId.toString());
    params.set('msg', msg.toString());

    return this.http.get(new UrlConfig(`${this.USER_FRIENDS_BASE_URL}RemoveFriend${params.getQuery()}`, this.mainEndPoint), showSpinner);
  }
