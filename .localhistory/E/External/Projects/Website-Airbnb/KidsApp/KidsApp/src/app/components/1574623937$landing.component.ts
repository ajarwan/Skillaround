...
export class LandingComponent extends BaseComponent implements OnInit {
  ...
  initPlacesAPI() {
    ...
    this.gmapVisible = new google.maps.Map(this.mapElement.nativeElement);
    ...
    let service = new google.maps.places.PlacesService(this.gmapVisible, { center: sydney, zoom: 15 });
