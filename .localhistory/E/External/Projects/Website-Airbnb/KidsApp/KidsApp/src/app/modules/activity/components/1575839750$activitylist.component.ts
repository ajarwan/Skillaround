...
export class ActivityListComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public LoadActivities() {
    ...
    if (this.FinalCriteria.DateRange && this.FinalCriteria.DateRange.length > 0) {
      this.FinalCriteria.FromDate = new Date()//new Date(this.FinalCriteria.DateRange[0]);
      this.FinalCriteria.ToDate = new Date()//new Date(this.FinalCriteria.DateRange[1]);
    };
