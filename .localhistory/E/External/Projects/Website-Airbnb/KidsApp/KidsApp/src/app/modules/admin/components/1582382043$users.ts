...
export class AdminUsers extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public LoadUsers() {
    ...
    this.UsersSVC.FindAllUsers(Cri, this.Pager.PageIndex, this.Pager.PageSize, null, null, false).subscribe((res: any) => {
      this.Users = res.d;
  ...
  public OpenAttachmentsModal(user: any) {
    ...
    this.modalService.open(this.UserAttachmentsModal, modoptions).result.then((result) => {
