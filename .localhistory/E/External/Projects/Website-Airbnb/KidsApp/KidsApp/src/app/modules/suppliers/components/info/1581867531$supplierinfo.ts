  ...
  public LoadUserDetails() {
    this.userSVC.GetUserDetails().subscribe((res: any) => {
      ...
      if (this.User.YearOfEstablishment)
        this.User.YearOfEstablishment = new Date(this.User.YearOfEstablishment);

      if (this.User.LicenseIssueDate)
        this.User.LicenseIssueDate = new Date(this.User.LicenseIssueDate);

      this.User.LicenseIssueDate = new Date('03/03/2019 10:00')
