...
export class SocialMedialService {
  ...
  public resources: any = DataStore.get('Resources');
  ...
  private getUserInfo() {
    ...
    FB.api(`/me?fields=id,name,email,gender,birthday,first_name,last_name,picture`, (res) => {
      ...
      this.userSVC.Signup(user, true).subscribe((innerRes: any) => {
        ...
        //ToDO , USer Already Exisit
        SharedService.ShowNotificationDialog(this.resources.UserAlreadyExisit, AppEnums.DialogType.Error, null, null, this.resources.General_Ok);
