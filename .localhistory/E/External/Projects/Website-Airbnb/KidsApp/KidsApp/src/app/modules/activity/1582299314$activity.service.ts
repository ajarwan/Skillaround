...
export class ActivityService {
  ...
  * **********************************/
  ...
  public FindAllBookings(booking: any, showSpinner: boolean = false): Observable<Response> {

    return this.http.get(new UrlConfig(`${this.BOOKING_BASE_URL}FindAll`, this.mainEndPoint), booking, showSpinner);
