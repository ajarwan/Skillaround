...
import { OlomnaService } from 'src/app/services/olomna.service';
...
*      Constructor
*****************************/
  constructor(private olomnaSVC: OlomnaService) {
    super();
  }
        ...
        reader.onloadend = function (e: any) {
          deferred.resolve(e.target.result).promise().done((x) => {
            ...
            me.olomnaSVC.uploadCPCImages([uploadedfile], false).subscribe((res: any) => {
              ...
              //res[0].d.
              ///EventImages/6941a538-0c54-4db3-a865-ef566a018e3f.jpg
            });
