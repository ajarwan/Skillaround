...
export class ActivityList extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public DrawMap() {
    ...
    google.maps.event.addListener(this.GmapVisible, 'idle', function (ev) {
  ...
  public FindAllBordersMarks() {
    ...
    setTimeout(() => {
      let MapMarks = [];
      let MarksData = [{ Lat: '25.17284965631571', Lng: '55.23390376714974' }, { Lat: '25.134003852893898', Lng: '55.225720347445304' }];
      let me = this;
