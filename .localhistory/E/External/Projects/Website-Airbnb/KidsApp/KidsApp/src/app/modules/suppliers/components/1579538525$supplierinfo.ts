...
export class SupplierInfo extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public OnSaveDetails() {
    ...
    debugger;
    this.User.StartWorkingTime = this.formatDate(this.SelectedStartTime.toDateString(), 'hh:mm');
    this.User.EndWorkingTime = this.formatDate(this.SelectedEndTime.toDateString(), 'hh:mm');
