...
export class UsersService {
  ...
  public Signup(user: any, password: string = null, showLoader: boolean = true): Observable<Response> {
    ...
    return this.http.post(new UrlConfig(`${this.USER_BASE_URL}Signup${params.getQuery()}`, this.mainEndPoint), user, showLoader);
  }
