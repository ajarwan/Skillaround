...
export class UsersService {
  ...
  public UpdateUserDTO(userDTO: any): Observable<Response> {
    return this.http.post(new UrlConfig(`${this.USER_BASE_URL}DetailsDTO`, this.mainEndPoint), userDTO, false);
  }

  public UpdateSupplierInfo(user: any): Observable<Response> {
    return this.http.post(new UrlConfig(`${this.USER_BASE_URL}UpdateSupplier`, this.mainEndPoint), user, false);
  }
