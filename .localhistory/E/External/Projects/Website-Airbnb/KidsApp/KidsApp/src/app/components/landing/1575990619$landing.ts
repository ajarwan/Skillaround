...
export class Landing extends BaseComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public OnSerach() {
    ...
    if (this.Criteria.From)
      Cri.from = CoreHelper.formatDateForUI(this.Criteria.From, 'dd/MM/yyyy');

    if (this.Criteria.To)
      Cri.to = CoreHelper.formatDateForUI(this.Criteria.To, 'dd/MM/yyyy');
  ...
  public OnLocationSelect(location: any) {
