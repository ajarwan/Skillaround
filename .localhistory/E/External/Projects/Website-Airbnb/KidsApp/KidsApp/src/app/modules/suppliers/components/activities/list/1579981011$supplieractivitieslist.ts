...
export class SupplierActivitiesList extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public LoadSupplierActivities() {
    ...
    this.IsLoaing = true;
    this.activitySVC.FindAllActivities(criteria, this.Pager.PageIndex, this.Pager.PageSize, 'CreateDate DESC', this.ActivityIncludes.join(','), false).subscribe((res: any) => {
      this.IsLoaing = false;
