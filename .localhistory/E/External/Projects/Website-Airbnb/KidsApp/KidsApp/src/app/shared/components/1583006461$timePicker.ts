...
export class Timepicker implements OnInit, OnDestroy {
  ...
  @Input('appError') appError: boolean;
  ...
  writeValue(value: any): void {
    ...
    if (value) {
      ...
      this.Hours = parseInt(tempItems[0]);
      ...
      this.Mins = parseInt(tempItems[1]);
      this.SetDisplayText();
  ...
  public propagateChangeFn() {
    ...
    let hrs = parseInt(this.Hours.toString());
    let mins = parseInt(this.Mins.toString());
