...
export class Landing extends BaseComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public LocationsList$: Observable<any[]>;
  ...
  public SearchLocations(searchParam: any) {
    ...
    //this.LocationsList$ = this.smSVC.GetGoogleLocations(key);
    this.LocationsList$ = this.smSVC.GetGoogleLocations(key).subscribe((res: any) => {
      console.log(res)''
    })
    //console.log(;
