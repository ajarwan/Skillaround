...
export class SupplierBooking extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public LoadActivityBookings(activity: any) {
    ...
    tempCri.ActivityId = activity.Id;
    tempCri.Title = this.FinalCriteria.Title;
    ...
    debugger;
    this.ActivitySVC.FindAllBookings(tempCri, activity.Pager.PageIndex, activity.Pager.PageSize, "CreateDate DESC", this.BookingIncludes.join(','), false).subscribe((innerRes: any) => {
