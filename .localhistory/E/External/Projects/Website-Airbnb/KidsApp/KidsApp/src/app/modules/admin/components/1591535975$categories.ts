...
export class AdminCategorries extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public Icons: any[] = [
    ...
    { Icon: 'fas fa-air-freshener', Img: 'camp.png' },
    { Icon: 'fas fa-archway', Img: 'camp.png' },
    { Icon: 'fas fa-baby', Img: 'camp.png' },
    { Icon: 'fas fa-baby-carriage', Img: 'camp.png' },
    { Icon: 'fas fa-baseball-ball', Img: 'camp.png' },
    { Icon: 'fas fa-basketball-ball', Img: 'camp.png' },
    { Icon: 'fas fa-bed', Img: 'camp.png' },
    { Icon: 'fas fa-biking', Img: 'camp.png' },
    { Icon: 'fas fa-bong', Img: 'camp.png' },
    { Icon: 'fas fa-broom', Img: 'camp.png' },
    { Icon: 'fas fa-chalkboard-teacher', Img: 'camp.png' },
    { Icon: 'fas fa-chess', Img: 'camp.png' }
  ];
