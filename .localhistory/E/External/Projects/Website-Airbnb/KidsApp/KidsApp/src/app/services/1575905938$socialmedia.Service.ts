...
export class SocialMedialService {
  ...
  public GetGoogleLocations(term: string = null): Observable<any[]> {
    ...
    return of(service.getQueryPredictions({ input: term, sessionToken: sessionToken }, displaySuggestions));
