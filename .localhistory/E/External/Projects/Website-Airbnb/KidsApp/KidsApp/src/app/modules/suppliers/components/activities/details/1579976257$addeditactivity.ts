  ...
  * ***************************************/
  ...
  public DrawMap() {
    ...
    this.GmapVisible.addListener('click', (ev) => {
      ...
      this.Activity.Lat = marker.position.lat;
      this.Activity.Lng = marker.position.lng;
  ...
  public OnSave() {
    ...
    //this.Activity.Thumbnail = this.Activity.Documents.filter((x: any) => x.IsMain && !x.IsDeleted)[0]
  ...
  public ValidateActivity(): boolean {
    ...
    if (Validator.StringIsNullOrEmpty(this.Activity.LocationName))
