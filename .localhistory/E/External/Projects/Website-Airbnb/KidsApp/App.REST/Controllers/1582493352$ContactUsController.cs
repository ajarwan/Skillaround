...
namespace App.REST.Controllers
{
    ...
    public class ContactUsController : BaseController
    {
        ...
        public async Task<IHttpActionResult> FindAllContactUsMessages(SharedEnums.SeenStatus seenStatus = SharedEnums.SeenStatus.All,
            int pageIndex = 1, int pageSize = 10, string include = null, string orderBy = "IsSeen ASC, CreateDate DESC")
        {
            try
            {
        ...
        public async Task<IHttpActionResult> FindContacUsMessagesCount()
        {
            try
            {
                ...
                Expression<Func<ContactUsMessage, bool>> Filter = x => !x.IsDeleted && !x.IsScaned;
