...
namespace App.REST.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        [Route("FindAll")]
        [HttpGet]
        public async Task<IHttpActionResult> FindAllUsers(string keyword = null, SharedEnums.UserTypes type = SharedEnums.UserTypes.All,
             int pageIndex = 1, int pageSize = 10, string include = null, string orderBy = "CreateDate DESC")
        {
            try
            {
                ...
                if (type != SharedEnums.UserTypes.All)
                {
                    Filter = Filter.And(x => x.UserType == type);
                }
