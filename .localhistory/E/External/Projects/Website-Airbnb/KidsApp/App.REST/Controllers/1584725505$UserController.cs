    ...
    public class UserController : BaseController
    {
        ...
        public IHttpActionResult SaveToken(Token token)
        {
            try
            {
                ...
                {
                    cus = JsonConvert.DeserializeObject<Customer>(response.Content);
                }

                //Save Card
                //var client1 = new RestClient("https://api.tap.company/v2/card/%7Bcustomer_id%7D");
                //var request1 = new RestRequest(Method.POST);
                //request1.AddHeader("content-type", "application/json");
                //request1.AddHeader("authorization", "Bearer sk_test_XKokBfNWv6FIYuTMg5sLPjhJ");
                //request1.AddParameter("application/json", "{\"source\":\"" + token.id + "\"}", ParameterType.RequestBody);
