...
namespace App.REST.Controllers
{
    ...
    public class CategoryController : BaseController
    {
        ...
        [Route("FindAll")]
        [HttpGet]
        public async Task<IHttpActionResult> FindAllCategories(string title = null, SharedEnums.ActivationStatus activationStatus = SharedEnums.ActivationStatus.Active, int pageIndex = 1, int pageSize = 10,
