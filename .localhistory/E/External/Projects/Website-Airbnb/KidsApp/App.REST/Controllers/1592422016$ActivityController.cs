...
namespace App.REST.Controllers
{
    ...
    public class ActivityController : BaseController
    {
        ...
        public async Task<IHttpActionResult> FindAllActivities(string title = null, string description = null, string keyword = null,
            ...
            string bookingUserName = null, string bookingUserEmail = null, SharedEnums.BookingConfirmationStatus bookingStatus = SharedEnums.BookingConfirmationStatus.All)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(bookingUserEmail))
                {
                    ...
                    Filter = Filter.And(x => x.Bookings.Any(y => !y.IsDeleted && y.User.Email.Contains(bookingUserEmail)));
                }
