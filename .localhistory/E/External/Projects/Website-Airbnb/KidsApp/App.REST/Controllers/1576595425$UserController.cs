...
namespace App.REST.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        [Route("Signup")]
        [HttpPost]
        public IHttpActionResult Signup(User user,string password)
        {
            try
            {
                ...
                if (user.LoginProvider != SharedEnums.LoginProvider.System)
                    user.PasswordHash = ConfigurationManager.AppSettings["SocialUsersKey"].ToString();
                ...
                Mgr.AddUpdate(user);
                Unit.SaveChanges();
                user.PasswordHash = Helper.DecryptHash(user.PasswordHash, ConfigurationManager.AppSettings["EnToken"]);
