...
namespace App.REST.Controllers
{
    ...
    public class ActivityController : BaseController
    {
        ...
        [Route("")]
        [HttpGet]
        public async Task<IHttpActionResult> FindActivityById(int id, string include = null)
        {
            try
            {
                if (id < 1)
            ...
            string include = null, string orderBy = "CreateDate DESC")
        {
            try
            {
                ...
                var activities = await Mgr.FindAll_Async(Filter,Helper.ToStringArray(orderBy), pager, Helper.ToStringArray(include));
