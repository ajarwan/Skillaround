...
namespace App.REST.Controllers
{
    ...
    public class MessageController : BaseController
    {
        ...
        public void SendUserCommunicationEmail(string senderFullName, string msgBody, string to)
        {
            ...
            text = text.Replace("{{UserSentYouAmessageSubject}}", App.Entity.Resources.KidsApp.SentYouEmailSubject);
            ...
            MailSender.SendEmail(App.Entity.Resources.KidsApp.WelcomEmailSubject, text, to);
