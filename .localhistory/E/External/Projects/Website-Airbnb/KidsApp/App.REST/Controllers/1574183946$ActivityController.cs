...
namespace App.REST.Controllers
{
    ...
    public class ActivityController : BaseController
    {
        ...
        [Route("")]
        [HttpGet]
        public async IHttpActionResult FindActivityById(int id, string include = null)
        {
            try
            {
                return Mgr.FindById_Async(id, Helper.ToStringArray(include));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IHttpActionResult> FindAllActivities(string title = null, string description = null,
            ...
            bool isPosted = true, bool myActivities = false, int pageIndex = 1, int pageSize = 10, string include = null, string orderBy = "CreateDate DESC")
        {
            try
            {
                ...
                var activities = await Mgr.FindAll_Async(Filter, orderBy, pager, include);
