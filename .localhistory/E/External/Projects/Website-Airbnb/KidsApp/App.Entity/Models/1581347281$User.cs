...
namespace App.Entity.Models
{
    public class User : EntityBase, IPrincipal, IIdentity
    {
        ...
        public bool IsSupplierVerified { get; set; } = false;
        #endregion
        ...
        public string StartTimeFormatted
        {
            get
            {
                ...
                if (hrs >= 12)
                {
                    return (hrs - 12).ToString().PadLeft(2, '0') + ":" + mins.ToString().PadLeft(2, '0') + (hrs >= 12 ? pm : am);
                }
                {
                    return hrs.ToString().PadLeft(2, '0') + ":" + mins.ToString().PadLeft(2, '0') + (hrs > 11 ? pm : am);
