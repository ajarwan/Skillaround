...
namespace App.Business.Extended
{
    public class BookingManager : BusinessBase<Booking>
    {
        ...
        public void SendBookingNotificationEmail(Booking entity)
        {
            ...
            //Test
            entity.User.Email = entity.Activity.Supplier.Email = "alijarwan90@gmail.com";
           ...
           //////Send Email To User
            ...
            MailSender.SendEmail(App.Entity.Resources.KidsApp.BookingDetails, text, entity.Activity.Supplier.Email);
        }
