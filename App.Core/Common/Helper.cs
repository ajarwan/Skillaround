...
namespace App.Core
{
    public static class Helper
    {
        ...
        public static string GetTemplateLocationByName(string name)
        {
            var path = AppDomain.CurrentDomain.BaseDirectory + @"\bin\AD";
            var TemplatePath = "";
            
            TemplatePath = Path.Combine(path, name);

            return TemplatePath.Replace(@"file:\\", "");
        }
