...
export class PACAdmin extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public LoadData() {
    this.IsLoading = true;
    this.AdminSVC.FindContentAdminByType(AppEnums.ContentAdminType.Privacy, false).subscribe((res: any) => {
      if (res)
        this.AdminContent = res;
      else
        this.AdminContent = {
          Type: AppEnums.ContentAdminType.Privacy
        };
