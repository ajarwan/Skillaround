...
@Component({
  selector: 'shared-activitydetails',
  ...
  *************************************/
  ...
  public ngOnInit() {
    ...
    if (this.ActivityId) {
      ...
      if (this.ActiveUser.UserType == AppEnums.UserTypes.Manager) {
        this.navigate('admin/managedactivities');
      }
      else {
  ...
  public LoadActivityDetails() {
    ...
    this.activitySCV.FindActivityById(this.ActivityId, this.ActivityIncludes.join(','), false).subscribe((res: any) => {
      if (!res || (res.SupplierId != this.ActiveUser.Id && this.ActiveUser.UserType != AppEnums.UserTypes.Manager))
        this.navigate('supplier/activities');
  ...
  public GoToActivityEditPage() {
    if (this.ActiveUser.UserType == AppEnums.UserTypes.Manager) {
      this.navigate('admin/managedactivities/edit/' + this.ActivityId);
    }
    else {
