...
export class TACAdmin extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public LoadData() {
    this.IsLoading = true;
    this.AdminSVC.FindContentAdminByType(AppEnums.ContentAdminType.TAC, false).subscribe((res: any) => {
      if (res)
        this.AdminContent = res;
      else
        this.AdminContent = {
          Type: AppEnums.ContentAdminType.TAC
        };
