    ...
    public partial class AddNotifications : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        TextAr = c.String(),
                        TextEn = c.String(),
                        MessagingQueueId = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.MessagingQueues", t => t.MessagingQueueId, cascadeDelete: true)
                .ForeignKey("dbo.Bookings", t => t.RelatedBookingId)
                .ForeignKey("dbo.Users", t => t.ToUserId, cascadeDelete: true)
                .ForeignKey("dbo.UserFriends", t => t.UserFriend_Id)
                .Index(t => t.ToUserId)
                .Index(t => t.FromUserId)
                .Index(t => t.MessagingQueueId)
                .Index(t => t.RelatedBookingId)
                .Index(t => t.UserFriend_Id);
            
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.Notifications", "UserFriend_Id", "dbo.UserFriends");
            ...
            DropIndex("dbo.Notifications", new[] { "UserFriend_Id" });
